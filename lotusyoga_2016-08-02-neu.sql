...
# Database: lotusyoga
# Generation Time: 2016-08-02 13:49:08 +0000
# ************************************************************
...
INSERT INTO `carts` (`id`, `user_id`, `guest_id`, `product_id`, `order_id`, `quantity`, `product_size`, `is_active`, `created_at`, `deleted_at`)
VALUES
	...
	(26,2,18,9,13,1,'s',1,'2016-08-02 12:59:48',NULL),
	(27,2,18,7,13,1,'m',1,'2016-08-02 12:59:48',NULL),
	(28,2,18,12,13,1,'m',1,'2016-08-02 12:59:48',NULL),
	(29,41,30,9,NULL,2,'s',0,'2016-08-02 12:47:17',NULL);
...
VALUES
	...
	(29,'',1,'2016-08-02 12:42:09',NULL),
	(30,'',1,'2016-08-02 12:42:58',NULL),
	(31,'',1,'2016-08-02 12:59:29',NULL),
	(32,'',1,'2016-08-02 12:59:33',NULL),
	(33,'',1,'2016-08-02 13:07:35',NULL),
	(34,'',1,'2016-08-02 13:07:38',NULL),
	(35,'',1,'2016-08-02 13:08:08',NULL);
...
INSERT INTO `orders` (`id`, `user_id`, `guest_id`, `payment_option_id`, `delivery_option_id`, `delivery_address`, `receipt_address`, `cart_id`, `coupon_code_id`, `status`, `is_active`, `created_at`, `deleted_at`)
VALUES
	...
	(13,41,0,2,1,'Siebenbrunnengasse 88,1212,Wien','Siebenbrunnengasse 88,1212,Wien',NULL,0,0,1,'2016-08-02 13:30:00',NULL);
...
INSERT INTO `payment_options` (`id`, `_name`, `is_active`, `deleted_at`)
VALUES
	(1,'Vorkasse',1,NULL),
	(2,'Rechnung',1,NULL),
	(3,'Nachname',1,NULL);
...
VALUES
	...
	(37,12,'l',26,NULL),
	(38,12,'xl',25,NULL),
	(39,18,'onesize',14,NULL),
	(40,17,'onesize',99,NULL),
	(41,16,'onesize',25,NULL),
	(42,15,'onesize',42,NULL),
	(43,14,'onesize',33,NULL),
	(44,13,'onesize',14,NULL),
	(45,11,'onesize',14,NULL),
	(46,8,'onesize',14,NULL);
...
VALUES
	...
	(2,'Alexandra Benkö',2147483647,'alex@text.at','das komentar','2016-08-02 13:16:22',NULL,NULL),
	(3,'Alexandra Benkö',2147483647,'alex@text.at','das komentar','2016-08-02 13:17:44',NULL,NULL),
	(4,'Alexandra Benkö',2147483647,'alex@text.at','das komentar','2016-08-02 13:17:55',NULL,NULL),
	(5,'alex',2147483647,'alex@text.at','test','2016-08-02 13:18:27',NULL,NULL),
	(6,'alex',2147483647,'alex@text.at','test','2016-08-02 13:18:51',NULL,NULL),
	(7,'Chris Kunz',2147483647,'chris@test.at','hwfh','2016-08-02 13:32:52',NULL,NULL),
	(8,'Chris Kunz',2147483647,'chris@test.at','text','2016-08-02 13:33:49',NULL,NULL);
...
VALUES
	...
	(41,'testtest','Test Test','test@test.at','$2y$10$F5r5VM8AyAKf4FxFXftIduFrjCUtvk/SYbychAoHnskC4zyUFAqkC','on','2016-08-01','','','Siebenbrunnengasse 88',1212,'Wien','2016-08-02 12:46:00',1,NULL);
