...
--
-- Host: localhost
-- Generation Time: Apr 20, 2016 at 12:19 PM
...
INSERT INTO `kurse` (`id`, `kursname`, `beschreibung`, `is_active`, `deleted_at`) VALUES
...
INSERT INTO `shop_categories` (`id`, `category_name`, `is_active`, `deleted_at`) VALUES
(1, 'Bekleidung', 1, NULL),
(2, 'Zubehör', 1, NULL),
(3, 'Sonstiges', 1, NULL),
(4, 'Alle', 1, NULL);
...
INSERT INTO `staff` (`id`, `fullname`, `email`, `telno`, `pic`, `kurse_id`, `description`, `is_active`, `deleted_at`) VALUES
